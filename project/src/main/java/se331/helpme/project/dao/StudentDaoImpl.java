...
public class StudentDaoImpl implements StudentDao{
    ...
    @Override
    public Page<Student> getStudent(String firstname, Pageable page) {
        return studentRepository.findByFirstNameContainingIgnoreCaseOrLastNameContainingIgnoreCaseOrStudent_ID
                (firstname, firstname, firstname, firstname, page);
    }
}
